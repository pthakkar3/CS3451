...
def green_mountain():
    ...
    for i in range(-100, 90, 10):
        for j in range(-100, 90, 10):
            ...
            vertex(i, j, 0, (i + 100.0)/200.0, (j + 100.0)/200.0)
            vertex(i + 10.0, j, 0, (i + 110.0)/200.0, (j + 100)/200.0)
            vertex(i + 10.0, j + 10.0, 0, (i + 110.0)/200.0, (j + 110.0)/200.0)
            vertex(i, j + 10.0, 0, (i + 100.0)/200.0, (j + 110.0)/200.0)
